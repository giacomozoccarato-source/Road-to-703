...
window.ROAD703_FIREBASE={queueSave,login:()=>auth.signInWithPopup(provider).catch(e=>{console.error(e);emit("error","Accesso non riuscito",String(e.message||e))}),logout:()=>auth.signOut()};
})();
